...
def main():
    """
	TODO: use recursive to draw a sierpinski triangle
	"""
...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
    """
	:param order: int, the order of the triangle
    ...
    if order == 0:
        ...
        sierpinski_triangle(order - 1, length / 2, upper_left_x + ((length / 2) * 0.5),
